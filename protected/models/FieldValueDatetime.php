<?php
/**
 * This is the model class for table "field_value_datetime".
 *
 * The followings are the available columns in table 'field_value_datetime':
 * @property integer $id
 ...
 */
class FieldValueDatetime extends MyActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return FieldValueDatetime the static model class
	 */
