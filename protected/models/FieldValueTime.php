...
/**
 * This is the model class for table "field_value_time".
 *
 * The followings are the available columns in table 'field_value_time':
 * @property integer $id
 ...
 */
class FieldValueTime extends MyActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return FieldValueTime the static model class
	 */
