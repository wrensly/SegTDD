 ...
 *
 * The followings are the available columns in table 'constraint_computed':
 * @property integer $id
 ...
 */
class ConstraintComputed extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ConstraintComputed the static model class
	 */
