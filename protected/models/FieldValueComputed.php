...
/**
 * This is the model class for table "field_value_computed".
 *
 * The followings are the available columns in table 'field_value_computed':
 * @property integer $id
 ...
 */
class FieldValueComputed extends MyActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return FieldValueComputed the static model class
	 */
