 ...
 *
 * The followings are the available columns in table 'field_value_numeric':
 * @property integer $id
 ...
 */
class FieldValueNumeric extends MyActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return FieldValueNumeric the static model class
	 */
