...
/**
 * This is the model class for table "field_value_date".
 *
 * The followings are the available columns in table 'field_value_date':
 * @property integer $id
...
class FieldValueDate extends MyActiveRecord
{
	 ...
	 * @return FieldValueDate the static model class
	 */
